...
export class StepIasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.selectedPrimery = this.forecastModelService.ticketInformation.history.primeryBolChange;
